...
classifier.add(Dense(units = 800,activation='relu',input_dim=784,init='uniform'))

classifier.add(Dense(units = 800,activation='relu',init='uniform'))

classifier.add(Dense(units = 400,activation='relu',init='uniform'))

classifier.add(Dense(units = 200,activation='relu',init='uniform'))

classifier.add(Dense(units = 64,activation='relu',init='uniform'))

classifier.add(Dense(units = 64,activation='relu',init='uniform'))

classifier.add(Dense(units = 32,activation='relu',init='uniform'))

classifier.add(Dense(units = 10,activation='softmax',init='uniform'))
...
y_ann_sol = pd.DataFrame(y_num,columns=['ImageId','Label']).to_csv('y_ann_sol.csv')
